...
"depends=clounix_platform,curr_sensor_dev_driver,vol_sensor_dev_driver,pmbus_core";

MODULE_ALIAS("of:N*T*Cmps,mp2886");
MODULE_ALIAS("of:N*T*Cmps,mp2886C*");
MODULE_ALIAS("i2c:mp2886");
