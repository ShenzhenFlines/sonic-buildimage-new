...
#define SYSEEPROM_BUS_CLX12800 7
...
#define PORT_PLATFORM_CLX128000 128000
#define PORT_CLK_DIV_CLX128000 (0x7D)

#define FAN_MAX_CLX128000 6
#define MOTOR_NUM_PER_FAN_CLX128000   1
#define FAN_BUS_CLX128000 5
...
struct sensor_descript clx12800_sensor_map_index[] = {
    ...
    {"i2c-0-mux (chan_id 4)", 0x48, "FAN 0x48"},
    {"i2c-0-mux (chan_id 4)", 0x49, "FAN 0x49"},
    {"cpu 0", 0, "cpu 0"},
    {"cpu 1", 0, "cpu 1"},
    {"cpu 2", 0, "cpu 2"},
    {"cpu 3", 0, "cpu 3"},
