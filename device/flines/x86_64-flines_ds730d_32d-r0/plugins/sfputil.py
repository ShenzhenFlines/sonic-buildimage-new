...
class SfpUtil(SfpUtilBase):
    ...
    def get_low_power_mode(self, port_num):
        if port_num not in self.qsfp_ports:
            return False
        lowpower_path = '/sys/switch/transceiver/eth{}/lpmode'.format(
            port_num + 1)
    ...
    def read_porttab_mappings(self, porttabfile, asic_inst=0):
        ...
        for line in f:
            ...
            if (fp_port_index > self.PORT_END):
                continue
    ...
    def get_transceiver_dom_threshold_info_dict(self, port_num):
        ...
        if port_num in self.qsfp_ports:
            ...
            if dom_module_threshold_raw is not None:
                dom_module_threshold_data = sfpd_obj.parse_module_monitor_params(
            ...
            if dom_channel_threshold_raw is not None:
                dom_channel_threshold_data = sfpd_obj.parse_channel_thresh_monitor_params(
